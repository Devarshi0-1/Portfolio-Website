    ...
    const containerData = [
        {
            ...
            summaryText: (
                <>
                    <span>Weather and Memes app</span>; Single Page Application
                    using <strong>React Router</strong>, made with data from{" "}
        ...
        },
        {
            ...
            summaryText: (
                <>
                    <span>Easy ToDo job</span>; Organize yourself writing stuff
                    you need TO DO. Build with UI/UX as a top priority,uses{" "}
                    <strong>Glass Morphism UI Style</strong>, use this tool to
                    look the stunning animation it provides.
                </>
            ),
        ...
        },
        {
            ...
            summaryText: (
                <>
                    <span>Stone Paper Scissors</span>; It's You VS Computer
                    let's see who wins this Rock Paper Scissors game. Build with
                    attractive UI/UX and CSS animations with a stunning{" "}
        ...
        },
        {
            ...
            summaryText: (
                <>
                    <span>React Calculator</span>; A simple calculator with eye
                    pleasing UI and optimal UX Uses{" "}
                    <strong>3D and 2D CSS animations</strong> with{" "}
        ...
        },
        {
            ...
            summaryText: (
                <>
                    <span>Personal Portfolio</span>; You are here take a look!
                    This portfolio is made with ReactJS and uses the{" "}
                    <strong>API Flash</strong>to automate the Screenshots of my
